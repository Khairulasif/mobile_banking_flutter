...
List<BankingQuesAnsModel> bankingQuestionList() {
  ...
  var list1 = BankingQuesAnsModel("Question: How to transfer money ?");
  list.add(list1);

  var list2 = BankingQuesAnsModel(
      "Money return when you go shopping with credit card of Dhaka Bank ?");
  list.add(list2);
  ...
  var list4 = BankingQuesAnsModel(
      "Dhaka Bank give a giftbox for new customers who create account ?");
  list.add(list4);
...
List<BankingLocationModel> bankingLocationList() {
  ...
  var list1 = BankingLocationModel(location: "Motijheel Branch", m: "800m");
  list.add(list1);

  var list2 = BankingLocationModel(location: "Tejgaon Branch", m: "600m");
  list.add(list2);

  var list3 = BankingLocationModel(location: "Rampura Branch", m: "600m");
  list.add(list3);

  var list4 = BankingLocationModel(location: "Kawranbajar Branch", m: "2.5km");
  list.add(list4);
